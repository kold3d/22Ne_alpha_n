...
//
//
/// \file DRAGONEventAction.cc
/// \brief Implementation of the DRAGONEventAction class
...
DRAGONEventAction::~DRAGONEventAction()
{}
...
void DRAGONEventAction::EndOfEventAction(const G4Event*)
{   
