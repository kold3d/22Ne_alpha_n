...
//
//
/// \file DRAGONRunAction.cc
/// \brief Implementation of the DRAGONRunAction class
...
void DRAGONRunAction::BeginOfRunAction(const G4Run*)
{
...
//  G4double mass = detectorConstruction->GetScoringVolume()->GetMass();
  ...
  const DRAGONPrimaryGeneratorAction* generatorAction
   = static_cast<const DRAGONPrimaryGeneratorAction*>
...
void DRAGONRunAction::AddEdep(G4double edep)
{
  fEdep  += edep;
  fEdep2 += edep*edep;
}
