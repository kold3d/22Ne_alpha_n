...
//
//
/// \file DRAGONSteppingAction.cc
/// \brief Implementation of the DRAGONSteppingAction class
...
DRAGONSteppingAction::DRAGONSteppingAction(DRAGONEventAction* eventAction)
...
DRAGONSteppingAction::~DRAGONSteppingAction()
{}
...
//    fScoringVolume = detectorConstruction->GetScoringVolume();
    fScoringVolume = detectorConstruction->GetWorldVolume();
  }
